...
export type ExecutionState = 'idle' | 'initializing' | 'running' | 'paused' | 'asserting' | 'recovering' | 'finished' | 'aborted';
export type ExecutionEvent = 'start' | 'pause' | 'resume' | 'step_complete' | 'assertion_pass' | 'assertion_fail' | 'error' | 'abort' | 'finish';
